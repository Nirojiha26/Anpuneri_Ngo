  ...
  <div>
    ...
    <div className="page-header">
      <div className="container-custom text-center">
        ...
        <p className="text-primary-200 text-lg max-w-2xl mx-auto">
          Since 2010, we have been at the heart of our community — supporting families, educating children, and building hope where it's needed most.
        </p>
      </div>
    </div>
    ...
    <SectionWrapper bg="gray">
      <SectionHeader
        ...
        subtitle="These principles shape every decision we make and every program we run."
      />
    ...
    {/* Navigation Cards */}
    <SectionWrapper bg="white">
      <SectionHeader eyebrow="Explore More" title="Learn About Our Organization" />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { icon: <FiTarget className="w-6 h-6" />, label: 'Our Mission', path: '/mission', desc: 'The purpose that drives every program and decision we make.' },
          { icon: <FiEye className="w-6 h-6" />, label: 'Our Vision', path: '/vision', desc: 'The future we are working toward — a world without educational poverty.' },
          { icon: <FiUsers className="w-6 h-6" />, label: 'Our Team', path: '/team', desc: 'Meet the dedicated people who give their lives to this mission.' },
        ].map((card) => (
